...
import 'package:seguros/components/custom_modal_bottom_sheet.dart';
...
import 'package:seguros/pages/view/default_view.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Stack(
      children: [
                    ...
                    children: [
                      ...
                      Padding(
                        padding: EdgeInsets.only(
                            top: _systemPeddingTop, right: 16.0),
                        child: Row(
        ...
        AnimatedOpacity(
          opacity:
              _scrollPosition < _imageHeight - _systemPeddingBottom ? 0.0 : 1.0,
